...
class CircularProgressView @JvmOverloads constructor(
    ...
    init {
        attrs?.let {
            ...
            val stroke = typedArray.getDimension(R.styleable.CircularProgressView_stroke, 1f)
            val backgroundColor = typedArray.getColor(R.styleable.CircularProgressView_backgroundColor, ContextCompat.getColor(context, R.color.teal_700))
